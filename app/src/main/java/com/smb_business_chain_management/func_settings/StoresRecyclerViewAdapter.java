...
import com.smb_business_chain_management.func_settings.fragments.ConfirmDeleteDialogFragment;
import com.smb_business_chain_management.func_settings.fragments.EditStoreDialogFragment;
...
import static com.smb_business_chain_management.func_settings.SettingsActivity.utils;
...
class StoresRecyclerViewAdapter extends RecyclerView.Adapter<StoresRecyclerViewAdapter.storesViewHolder> {
    ...
    class CardItemListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            intent.putExtra("selectedStore", (Parcelable) data);
