...
//        Log.d(getString(Log.DEBUG), "DEBUG");
        ...
        Product newProduct = new Product(category.getId(), brand.getId(), description, measurement.getId(), false, false, productName, 0, true, sku, barcode, importPrice, retailPrice, wholesalePrice, null, null);
...
//        THIS_ACTION_BAR_MENU_CONFIRM_BUTTON.setEnabled(false);
        menu.findItem(R.id.action_get_all).setEnabled(false);
